...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Jailbreak_MiSTer.git"
CORE_NAME=(Arcade-Jailbreak)
...
UPSTREAM_CORE_NAME=(Arcade-Jailbreak)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Jailbreak.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Jailbreak.rbf)
